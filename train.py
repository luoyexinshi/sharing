...
parser.add_argument('--arch_name', type=str, default='densenet121', help='architecture [available: densenet, vgg]', required=True)
...
saved_model_path = torch.save(checkpoint, 'checkpoint.pth')
